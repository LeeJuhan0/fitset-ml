...
USER_PATHS = [
    ("get", "/api/v1/ios/data/presigned-url?class=SQUAT&deviceId=ABC12345"),
    ("post", "/api/v1/ios/data/upload-confirm"),
    ("get", "/api/v1/ios/model/latest"),
]
...
def test_basic_credentials_do_not_pass_user_endpoints(admin_client):
